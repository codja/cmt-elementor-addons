				...
				<form action="/" method="POST"
					...
					<div class="cm-form-submit-container">
						<button type="submit" class="cm-form-submit"
							style="background: <?php echo esc_attr( $settings['submit_background'] ); ?>; color: <?php echo esc_attr( $settings['submit_color'] ); ?>; font-family: <?php echo esc_attr( $settings['submit_font_family'] ); ?>; font-size: <?php echo esc_attr( $settings['submit_size'] ); ?>px; font-weight: <?php echo esc_attr( $settings['submit_font_weight'] ); ?>;">
